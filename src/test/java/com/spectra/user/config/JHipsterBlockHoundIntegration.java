package com.spectra.user.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.spectra.user.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.spectra.user.security.DomainUserDetailsService", "createSpringSecurityUser");
